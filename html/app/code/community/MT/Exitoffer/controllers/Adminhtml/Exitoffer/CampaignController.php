    ...
    public function saveAction()
    {
       ...
       //    Mage::getSingleton('adminhtml/session')->setFormData($data);
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('exitoffer')->__('Campaign was successfully saved.'));
    ...
    public function deleteAction()
    {
        if ($this->getRequest()->getParam('id')) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('exitoffer')->__('Campaign was successfully deleted.'));
                $this->_redirect('*/*/');
            } catch (Exception $e) {
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
                $this->_redirect('*/*/');
