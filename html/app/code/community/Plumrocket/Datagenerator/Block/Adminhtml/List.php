...
class Plumrocket_Datagenerator_Block_Adminhtml_List extends Mage_Adminhtml_Block_Widget_Grid_Container  {
	...
	public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('datagenerator')->__('Manage Data Feeds');
        
		$this->_updateButton('add', 'label', 'Add Data Feed');
    }
