...
$installer->updateAttribute($productEntityTypeId, 'delivery_time', 'used_for_sort_by', 1);

$installer->updateAttribute($productEntityTypeId, 'position', 'used_for_sort_by', 0);
