<?php
class HC_Layerednavigation_Block_Catalog_Layer_Filter_Price extends Mage_Catalog_Block_Layer_Filter_Price {
    ...
    public function __construct() {
        ...
        if(Mage::getStoreConfig('layerednavigation/layerfiler_config/enabled')){
           $this->setTemplate('HC/layerednavigation/filter.phtml');
        }
        //Mage::getConfig()->getModuleConfig('HC_Layerednavigation')->is('active', 'true');
    }
