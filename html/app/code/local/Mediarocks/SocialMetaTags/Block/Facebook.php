...
class Mediarocks_SocialMetaTags_Block_Facebook extends Mage_Core_Block_Template
{	
    public function __construct()
    {
        // get all property  tags
        $this->setTemplate('mediarocks/socialmetatags/facebook_meta.phtml');
        $this->tags = Mage::getModel('mediarocks_socialmetatags/head')->getOgTags();
    }
}