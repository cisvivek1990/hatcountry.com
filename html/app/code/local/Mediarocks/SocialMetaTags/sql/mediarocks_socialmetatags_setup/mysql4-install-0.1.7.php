...
// create table-columns for cms pages (TYPE_TEXT constant not defined in 1.5)
if (!version_compare(Mage::getVersion(), '1.6', '>=')) {
  
    $installer->run('
        ALTER TABLE  `cms_page` ADD  (
            `fb_share_image` VARCHAR( 255 ) NULL,
            `facebook_meta_title` VARCHAR( 255 ) NULL,
            `facebook_meta_description` VARCHAR( 255 ) NULL,
            `twitter_share_image` VARCHAR( 255 ) NULL,
            `twitter_meta_title` VARCHAR( 255 ) NULL,
            `twitter_meta_description` VARCHAR( 255 ) NULL
        );
    ');
}
else {
