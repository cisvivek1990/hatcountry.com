...
class Mediarocks_SocialMetaTags_Model_System_Config_Source_BundledPriceType
{
    public function toOptionArray()
    {
        return array(
            array(
                'value' => '0',
                'label' => 'Do not show any price',
            ),
            array(
                'value' => '1',
                'label' => 'Show minimum price',
            ),
            array(
                'value' => '2',
                'label' => 'Show maximum price',
            ),
        );
    }
}