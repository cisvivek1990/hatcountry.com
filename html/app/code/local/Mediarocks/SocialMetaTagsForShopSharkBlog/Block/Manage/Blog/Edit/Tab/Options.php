...
class Mediarocks_SocialMetaTagsForShopSharkBlog_Block_Manage_Blog_Edit_Tab_Options extends ShopShark_Blog_Block_Manage_Blog_Edit_Tab_Options {
    ...
    {   
        ...
        $fieldset = $form->addFieldset('blog_social', array('legend' => Mage::helper('blog')->__('Social Meta Data'), 'class' => 'fieldset-wide'));
