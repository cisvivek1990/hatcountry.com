...
require_once(Mage::getModuleDir('controllers','ShopShark_Blog').DS.'Manage' .DS.'BlogController.php');

class Mediarocks_SocialMetaTagsForShopSharkBlog_Manage_BlogController extends ShopShark_Blog_Manage_BlogController
{
